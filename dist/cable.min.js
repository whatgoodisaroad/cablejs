...
Cable.decorators=function(){return function(a,d){var c={};a("[cable]").each(function(d,h){a(h).is(":text")?c[h.id]=Cable.textbox("#"+h.id):c[h.id]=Cable.template("#"+h.id,h.innerText)});d(c)}};
