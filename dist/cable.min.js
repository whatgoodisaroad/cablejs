...
d+"'";})})}function x(){a(f,function(b,d){if("subdefinition"===b.type)if(y(d))s(d,function(g){g.splice(b.defineIndex,0,function(g){var a={};a[d]=g;Cable.define(a,{scope:b.scope})});delete f[d];b.fn.apply(window,g)});else throw"Illegal subdefinition: "+d+". Subdefs must depend only on libraries";})}function z(){a(f,function(b,d){if("event"===b.type&&!b.isWiredUp){var g=function(b){p(d,function(d){d(b)})};g.setDefault=function(d){b.value=d};b.wireup(g);b.isWiredUp=!0}})}function p(b,d){if(f.hasOwnProperty(b))A[f[b].type](b,
d);else throw"Cannot generate: '"+b+"' is not defined";}function q(b,d,g,a){void 0===g&&(g=[]);b.length?a&&a.hasOwnProperty(b[0])?q(b.slice(1),d,g.concat([a[b[0]]]),a):p(b[0],function(f){q(b.slice(1),d,g.concat([f]),a)}):d(g)}function s(b,d){var g=f[b]["in"].map(function(d){return m(d,f[b].scope)});q(g,d)}function t(b,d){B[f[b].type](b,d)}function u(b){t(b,function(){})}function y(b){return f[b]["in"].map(function(d){return"library"===f[m(d,f[b].scope)].type}).reduce(function(b,g){return b&&g})}var r=
...
scope:a}},library:function(b,d,a){f[b]={type:"library",path:d.path,shim:d.shim,handle:null,loaded:!1,scope:a}},scope:function(b,d,f){var e={};a(d,function(d,a){e["main"===a?b:b+"_"+a]=d});Cable.define(e,{reify:!1,wireup:!1,scope:{chain:f.chain.concat([b.replace(/^.+_/,"")])}})},subdefinition:function(b,a,g){f[b]={type:"subdefinition",in:c(a),fn:a,scope:g,defineIndex:e(a).indexOf("define")}},module:function(b,a,e){f[b]={type:"module",url:a.url,scope:e}},alias:function(b,a,e){f[b]={type:"alias",reference:a.reference,
