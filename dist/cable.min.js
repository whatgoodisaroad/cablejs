...
var r=["result","respond","type","event"],f={};Cable._debug=function(){return f};Cable.each=a;Cable.define=function(b,e){e=l({reify:!0,wireup:!0,scope:{chain:[]}},e);a(b,function(b,a){if(/^_/.test(a))throw"Illegal definition: names cannot begin with an underscore.";if(-1!=r.indexOf(a))throw"Illegal definition: "+a+" is a reserved word.";if(f.hasOwnProperty(a))throw"Illegal definition: "+a+" is already defined.";var d=null,d=b.hasOwnProperty("type")?b.type:k(b)?-1!=c(b).indexOf("result")||-1!=c(b).indexOf("respond")?
"synthetic":"effect":"sub";if(v.hasOwnProperty(d))v[d](a,b,e.scope);else throw"Illegal definiton: could not determine meaning of "+a;});(e.reify||e.wireup)&&n(function(){e.reify&&w();e.wireup&&x()})};var v={data:function(b,e,a){f[b]={type:"data",value:e.value,"in":[],out:[],helpers:e.helpers?e.helpers:{},scope:a}},synthetic:function(b,e,a){-1!=c(e).indexOf("respond")?f[b]={type:"synthetic",fn:e,value:null,invoked:!1,"in":d(e,e.context),out:[],resultIndex:c(e).indexOf("respond"),scope:a,coalesce:!1}:
f[b]={type:"synthetic",fn:e,value:null,invoked:!1,"in":d(e,e.context),out:[],resultIndex:c(e).indexOf("result"),scope:a,coalesce:!0}},effect:function(b,e,a){f[b]={type:"effect",fn:e,"in":d(e,e.context),out:[],scope:a}},event:function(b,e,a){f[b]={type:"event",value:e.defaultValue,wireup:e.wireup,isWiredUp:!1,invoked:!1,"in":[],out:[],scope:a}},library:function(b,a,c){f[b]={type:"library",path:a.path,shim:a.shim,handle:null,loaded:!1,scope:c}},sub:function(b,e,c){var f={};a(e,function(a,e){f["main"===
e?b:b+"_"+e]=a});Cable.define(f,{reify:!1,wireup:!1,scope:{chain:c.chain.concat([b])}})},module:function(b,a,c){f[b]={type:"module",url:a.url,scope:c}}},y={data:function(b,e){var c=function(){if(!arguments.length)return f[b].value;arguments[0]!=f[b].value&&(f[b].value=arguments[0],f[b].out.forEach(t))};a(f[b].helpers,function(b,a){c[a]=function(){return b.apply(c,arguments)}});e(c)},synthetic:function(b,a){f[b].invoked?a(function(){return f[b].value}):s(b,function(){})},effect:function(){},event:function(b,
a){a(function(){if(!arguments.length)return f[b].value;arguments[0]==f[b].value&&f[b].coalesce||(f[b].invoked=!0,f[b].value=arguments[0],f[b].out.forEach(t))})},library:function(b,a){f[b].loaded?a(f[b].handle):s(b,function(){p(b,a)})}};Cable.generate=p;var z={data:p.data,event:p.event,synthetic:function(b,a){u(b,function(c){c.splice(f[b].resultIndex,0,function(c){f[b].invoked=!0;f[b].value==c&&f[b].coalesce||(f[b].value=c,f[b].out.forEach(t));a()});f[b].fn.apply({},c)})},effect:function(b,a){u(b,
function(c){f[b].fn.apply({},c);a()})},library:function(b,a){if(f[b].loaded)a();else{var c=function(){var a,c,e={},d=0;arguments[d].substring&&d++;a=arguments[d].splice?arguments[d++]:["require","exports","module"];if(k(arguments[d])){var g=arguments[d];c=-1!==a.indexOf("exports")?function(){var b=g.apply(window,arguments);return void 0!==b?b:e}:g}else{var h=arguments[d];c=function(){return h}}q(a,function(a){f[b].handle=c.apply(window,a);f[b].loaded=!0},[],{require:function(){throw"Cable.js AMD loader does not support CommonJS style require.";
