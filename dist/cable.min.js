...
{getArgNames:d})})();Cable.withArgs=function(b,d){d.argAliases=b;return d};Cable.data=function(b,d){var e={type:"data",value:b};d&&(e.helpers=d);return e};Cable.define({init:Cable.withArgs(["event"],function(b){b(new Date)})},{reify:!1,wireup:!1});
