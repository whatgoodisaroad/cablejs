...
. 2014-07-06T05:47:27.328Z              .
.......................................*/
'use strict';var Cable={};"object"===typeof module&&"object"===typeof module.exports&&(Cable._private={},module.exports=Cable);
(function(){function b(c,h){for(var m in c)c.hasOwnProperty(m)&&h(c[m],m)}function a(c){if(c.argAliases)return c.argAliases;c=(c+"").match(/^function(\s*)?\(([^)]*)\)/m)[2];return c.length?c.split(",").map(function(c){return c.replace(/(^\s+)|(\s+$)/g,"")}):[]}function e(c,h){return a(c).filter(function(c){return-1==x.indexOf(c)}).map(function(c){return c.replace(/^_/,"")})}function d(c,h){return a(c).filter(function(c){return-1==x.indexOf(c)&&"_"!=c[0]})}function g(c){var h={};return c&&"[object Function]"===
h.toString.call(c)}function k(c){return-1!=a(c).indexOf("result")||-1!=a(c).indexOf("respond")}function p(c){return-1!==a(c).indexOf("define")}function l(c){c=a(c);return 1===c.length&&"event"===c[0]}function t(c,h){if(h){var m={};b(c,function(c,a){m[a]=h.hasOwnProperty(a)?h[a]:c});return m}return c}function q(c){function h(a){if(a.length){var m=a[0],b=new XMLHttpRequest;b.onreadystatechange=function(){if(4===this.readyState&&200===this.status){var c="("+this.responseText+")";delete f[m];var b={};
try{b[m]=eval(c)}catch(d){throw"Failed to load module '"+m+"': "+d;}Cable.define(b,{reify:!1,wireup:!1});h(a.slice(1))}};b.open("get",f[m].url,!0);b.send()}else c()}var m=[],a;for(a in f)f.hasOwnProperty(a)&&"module"===f[a].type&&m.push(a);h(m)}function s(c,h){for(var a="main"===h?"":"_"+h,b=[],d=0;d<c.length;++d)b.push(c.slice(0,c.length-d).join("_")+a);"main"!==h&&b.push(h);return b}function r(c,h){for(var a=s(h.chain,c),b=0;b<a.length;++b)if(f.hasOwnProperty(a[b]))return"alias"===f[a[b]].type?
(a=f[a[b]],r(a.reference,a.scope)):a[b];return null}function u(){b(f,function(c){c.out=[]});b(f,function(c,h){c.fn&&d(c.fn,c.context).forEach(function(a){var b=r(a,c.scope);if(b)f[b].out.push(h);else throw"Reference to undefined node '"+a+"' as dependency of '"+h+"'";})})}function n(){b(f,function(c,h){if("subdefinition"===c.type)if(C(h))y(h,function(a){a.splice(c.defineIndex,0,function(a){var b={};b[h]=a;Cable.define(b,{scope:c.scope})});delete f[h];c.fn.apply(window,a)});else throw"Illegal subdefinition: "+
h+". Subdefs must depend only on libraries";})}function D(){b(f,function(c,a){if("event"===c.type&&!c.isWiredUp){var b=function(c){v(a,function(a){a(c)})};b.setDefault=function(a){c.value=a};c.wireup(b);c.isWiredUp=!0}})}function v(c,a){if(f.hasOwnProperty(c))E[f[c].type](c,a);else throw"Cannot generate: '"+c+"' is not defined";}function w(c,a,b,d){void 0===b&&(b=[]);c.length?d&&d.hasOwnProperty(c[0])?w(c.slice(1),a,b.concat([d[c[0]]]),d):v(c[0],function(e){w(c.slice(1),a,b.concat([e]),d)}):a(b)}
function y(c,a){var b=f[c]["in"].map(function(a){return r(a,f[c].scope)});w(b,a)}function z(c,a){F[f[c].type](c,a)}function A(c){z(c,function(){})}function C(c){return f[c]["in"].map(function(a){return"library"===f[r(a,f[c].scope)].type}).reduce(function(c,a){return c&&a})}var x=["result","respond","type","event","define"],f={};Cable._debug=function(){return f};Cable.each=b;Cable.define=function(c,a){a=t({reify:!0,wireup:!0,scope:{chain:[]}},a);b(c,function(c,b){if(/^_/.test(b))throw"Illegal definition: names cannot begin with an underscore.";
if(-1!=x.indexOf(b))throw"Illegal definition: "+b+" is a reserved word.";if(f.hasOwnProperty(b))throw"Illegal definition: "+b+" is already defined.";var d=null;c.hasOwnProperty("type")?d=c.type:g(c)?k(c)?d="synthetic":p(c)?d="subdefinition":l(c)?(d="event",c={type:"event",wireup:c}):d="effect":d="scope";if(B.hasOwnProperty(d))B[d](b,c,a.scope);else throw"Illegal definiton: could not determine meaning of "+b;});(a.reify||a.wireup)&&q(function(){a.reify&&(u(),n(),u());a.wireup&&D()})};var B={data:function(c,
...
in:e(b),fn:b,scope:d,defineIndex:a(b).indexOf("define")}},module:function(c,a,b){f[c]={type:"module",url:a.url,scope:b}},alias:function(c,a,b){f[c]={type:"alias",reference:a.reference,scope:b}}},E={data:function(c,a){var d=function(){if(!arguments.length)return f[c].value;arguments[0]!=f[c].value&&(f[c].value=arguments[0],f[c].out.forEach(A))};b(f[c].helpers,function(c,a){d[a]=function(){return c.apply(d,arguments)}});a(d)},synthetic:function(c,a){f[c].invoked?a(function(){return f[c].value}):z(c,
function(){})},effect:function(){},event:function(c,a){a(function(){if(!arguments.length)return f[c].value;arguments[0]==f[c].value&&f[c].coalesce||(f[c].invoked=!0,f[c].value=arguments[0],f[c].out.forEach(A))})},library:function(c,a){f[c].loaded?a(f[c].handle):z(c,function(){v(c,a)})}},F={data:v.data,event:v.event,synthetic:function(c,a){y(c,function(b){b.splice(f[c].resultIndex,0,function(b){f[c].invoked=!0;f[c].value==b&&f[c].coalesce||(f[c].value=b,f[c].out.forEach(A));a()});f[c].fn.apply({},
b)})},effect:function(c,a){y(c,function(b){f[c].fn.apply({},b);a()})},library:function(a,b){if(f[a].loaded)b();else{var d=function(){var d,e,k={},l=0;arguments[l].substring&&l++;d=arguments[l].splice?arguments[l++]:["require","exports","module"];if(g(arguments[l])){var t=arguments[l];e=-1!==d.indexOf("exports")?function(){var a=t.apply(window,arguments);return void 0!==a?a:k}:t}else{var p=arguments[l];e=function(){return p}}w(d,function(d){f[a].handle=e.apply(window,d);f[a].loaded=!0;b()},[],{require:function(){throw"Cable.js AMD loader does not support CommonJS style require.";
},exports:k,module:null})};d.amd={};var e=new XMLHttpRequest;e.onreadystatechange=function(){if(4===this.readyState&&200===this.status){var b=this.responseText;f[a].shim&&(b=["define(function() {",b,"\nreturn ",f[a].shim,"; });"].join(""));var e=window.define;window.define=d;try{eval(b)}catch(g){throw"Failed evaluating library "+a+": "+g;}window.define=e;"$"===a&&$&&$.noConflict&&$.noConflict()}};e.open("get",f[a].path,!0);e.send()}}};Cable.initialize=function(a,b){"synthetic"===f[a].type&&(f[a].value=
b,f[a].invoked=!0)};Cable._private&&(Cable._private={getArgNames:a,getFanIn:e,getDependencies:d,isSynthetic:k,isSubDefinition:p,isEvent:l,extend:t,enumerateScopes:s})})();Cable.withArgs=function(b,a){a.argAliases=b;return a};Cable.data=function(b,a){var e={type:"data",value:b};a&&(e.helpers=a);return e};Cable.define({init:Cable.withArgs(["event"],function(b){b(new Date)})},{reify:!1,wireup:!1});
...
Cable.template=function(b,a){var e=(a.match(/\{\{[_a-zA-Z0-9]+\}\}/g)||[]).map(function(a){return a.replace(/\{|\}/g,"")});return{properties:Cable.pack(e),main:Cable.withArgs(["properties","$"],function(d,g){function k(a){return"number"===typeof a?a.toFixed(2):a}for(var p=a,l=0;l<e.length;++l)p=p.replace("{{"+e[l]+"}}",k(d()[e[l]]));g(b).html(p)})}};
