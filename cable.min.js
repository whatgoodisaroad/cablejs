...
function triggerDownstream(name){graph[name].out.forEach(trigger)}Cable.initialize=function(name,value){if(graph[name].type==="synthetic"){graph[name].value=value;graph[name].invoked=true}};Cable._debug=function(){return graph}})();Cable.data=function(value,helpers){var obj={type:"data",value:value};if(helpers)obj.helpers=helpers;return obj};
