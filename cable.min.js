...
function u(a,d){var b=e[a]["in"].map(function(d){return m(d,e[a].scope)});t(b,d)}function r(a,d){z[e[a].type](a,d)}function s(a){r(a,function(){})}var q=["result","respond","define","type","event"],e={};Cable._debug=function(){return e};Cable.define=function(a,d){d=l({reify:!0,wireup:!0,scope:{chain:[]}},d);c(a,function(a,c){if(/^_/.test(c))throw"Illegal definition: names cannot begin with an underscore.";if(-1!=q.indexOf(c))throw"Illegal definition: "+c+" is a reserved word.";if(e.hasOwnProperty(c))throw"Illegal definition: "+
