...
"module"===e[b].type&&h.push(b);d(h)}function m(a,d){for(var h=d.chain,b="main"===a?"":"_"+a,c=[],f=0;f<h.length;++f)c.push(h.slice(0,h.length-f).join("_")+b);c.push(a);for(h=0;h<c.length;++h)if(e.hasOwnProperty(c[h]))return c[h];return null}function w(){c(e,function(a){a.out=[]});c(e,function(a,d){a.fn&&g(a.fn,a.context).forEach(function(h){var b=m(h,a.scope);if(b)e[b].out.push(d);else throw"Reference to undefined node '"+h+"' as dependency of '"+d+"'";})})}function x(){c(e,function(a,d){"event"!==
a.type||a.isWiredUp||(a.wireup(function(a){p(d,function(d){d(a)})}),a.isWiredUp=!0)})}function p(a,d){if(e.hasOwnProperty(a))y[e[a].type](a,d);else throw"Cannot generate: '"+a+"' is not defined";}function t(a,d,b){void 0===b&&(b=[]);a.length?p(a[0],function(c){t(a.slice(1),d,b.concat([c]))}):d(b)}function u(a,d){var b=e[a]["in"].map(function(d){return m(d,e[a].scope)});t(b,d)}function r(a,d){z[e[a].type](a,d)}function s(a){r(a,function(){})}var q=["result","respond","define","type","event"],e={};
Cable._debug=function(){return e};Cable.each=c;Cable.define=function(a,d){d=l({reify:!0,wireup:!0,scope:{chain:[]}},d);c(a,function(a,c){if(/^_/.test(c))throw"Illegal definition: names cannot begin with an underscore.";if(-1!=q.indexOf(c))throw"Illegal definition: "+c+" is a reserved word.";if(e.hasOwnProperty(c))throw"Illegal definition: "+c+" is already defined.";var f=null,f=a.hasOwnProperty("type")?a.type:k(a)?-1!=b(a).indexOf("result")||-1!=b(a).indexOf("respond")?"synthetic":"effect":"sub";
if(v.hasOwnProperty(f))v[f](c,a,d.scope);else if("sub"!==f)throw"Illegal definiton: could not determine meaning of "+c;});(d.reify||d.wireup)&&n(function(){d.reify&&w();d.wireup&&x()})};var v={data:function(a,d,b){e[a]={type:"data",value:d.value,"in":[],out:[],helpers:d.helpers?d.helpers:{},scope:b}},synthetic:function(a,d,c){-1!=b(d).indexOf("respond")?e[a]={type:"synthetic",fn:d,value:null,invoked:!1,"in":f(d,d.context),out:[],resultIndex:b(d).indexOf("respond"),scope:c,coalesce:!1}:e[a]={type:"synthetic",
fn:d,value:null,invoked:!1,"in":f(d,d.context),out:[],resultIndex:b(d).indexOf("result"),scope:c,coalesce:!0}},effect:function(a,d,b){e[a]={type:"effect",fn:d,"in":f(d,d.context),out:[],scope:b}},event:function(a,d,b){e[a]={type:"event",value:d.defaultValue,wireup:d.wireup,isWiredUp:!1,invoked:!1,"in":[],out:[],scope:b}},library:function(a,d,b){e[a]={type:"library",path:d.path,shim:d.shim,handle:null,loaded:!1,scope:b}},sub:function(a,d,b){var e={};c(d,function(d,b){e["main"===b?a:a+"_"+b]=d});Cable.define(e,
{reify:!1,wireup:!1,scope:{chain:b.chain.concat([a])}})},module:function(a,b,c){e[a]={type:"module",url:b.url,scope:c}}},y={data:function(a,b){var f=function(){if(!arguments.length)return e[a].value;arguments[0]!=e[a].value&&(e[a].value=arguments[0],e[a].out.forEach(s))};c(e[a].helpers,function(a,b){f[b]=function(){return a.apply(f,arguments)}});b(f)},synthetic:function(a,b){e[a].invoked?b(function(){return e[a].value}):r(a,function(){})},effect:function(){},event:function(a,b){b(function(){if(!arguments.length)return e[a].value;
arguments[0]==e[a].value&&e[a].coalesce||(e[a].invoked=!0,e[a].value=arguments[0],e[a].out.forEach(s))})},library:function(a,b){e[a].loaded?b(e[a].handle):r(a,function(){p(a,b)})}};Cable.generate=p;var z={data:p.data,event:p.event,synthetic:function(a,b){u(a,function(c){c.splice(e[a].resultIndex,0,function(c){e[a].invoked=!0;e[a].value==c&&e[a].coalesce||(e[a].value=c,e[a].out.forEach(s));b()});e[a].fn.apply({},c)})},effect:function(a,b){u(a,function(c){e[a].fn.apply({},c);b()})},library:function(a,
b){if(e[a].loaded)b();else{var c=function(){var b=arguments.length-1;k(arguments[b])?e[a].handle=arguments[b]():e[a].handle=arguments[b];e[a].loaded=!0};c.amd={};var f=new XMLHttpRequest;f.onreadystatechange=function(){if(4===this.readyState&&200===this.status){var f=this.responseText;e[a].shim&&(f=["define(function() {",f,"\nreturn ",e[a].shim,"; });"].join(""));window.define=c;eval(f);delete window.define;"$"===a&&$&&$.noConflict&&$.noConflict();b()}};f.open("get",e[a].path,!0);f.send()}}};Cable.initialize=
function(a,b){"synthetic"===e[a].type&&(e[a].value=b,e[a].invoked=!0)}})();Cable.withArgs=function(c,b){b.argAliases=c;return b};Cable.data=function(c,b){var f={type:"data",value:c};b&&(f.helpers=b);return f};Cable.define({init:{type:"event",wireup:function(c){c(new Date)}}},{reify:!1,wireup:!1});
